  ...
  const checkSetup = async () => {
    ...
    try {
      ...
      if (tableError) {
        ...
        if (
          tableError.message.includes('relation "submissions" does not exist')
        ) {
          setErrors((prev) => [
            ...prev,
            'Table "submissions" does not exist. Please run the SQL setup script.',
          ]);
        } else {
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2 text-sm">
              ...
              <p>
                <strong>2. Open SQL Editor and run this script:</strong>
              </p>
...
GRANT USAGE ON SEQUENCE public.submissions_id_seq TO authenticated;`}
              ...
              <p>
                <strong>
                  3. Click "Run" and then retry the setup check above.
                </strong>
              </p>
            </div>
          </CardContent>
